...
namespace Escuta_Teltonika
{
    class Program
    {
        ...
        private const int EXTVOLTAGE = 66;
        private const int BATTERYVOLTAGE = 67;
        private const int IGNITION = 239;                
        private const int CRASH = 247;
        private const int JAMMING = 249;        
        ...
        public static void TraduzindoMensagem()
        {
            ...
            try
            {
                ...
                //                    lista[ultimo].Ext_Voltage + ";" +
                //                    lista[ultimo].Battery_Voltage + ";" +
                //                    lista[ultimo].Speed_;

                string mensagem = "FMB920;" +
                                    " Id:" + lista[ultimo].Id + ";" +
                                    " imei:" + imei + ";" +
                                    " GpsTime:" + lista[ultimo].GpsTime + ";" +
                                    " DataRastreador:" + lista[ultimo].DataRastreador.ToString("yyyyMMdd;HH:mm:ss") + ";" +
                                    " La:" + lista[ultimo].La.ToString().Replace(',', '.') + ";" +
                                    " Lo:" + lista[ultimo].Lo.ToString().Replace(',', '.') + ";" +
                                    " Ignicao:" + lista[ultimo].Ignicao + ";" +
                                    " Speed:" + lista[ultimo].Speed + ";" +
                                    " Direction:" + lista[ultimo].Direction + ";" +
                                    " Prioridade:" + lista[ultimo].Prioridade + ";" +
                                    " Altitude:" + lista[ultimo].Altitude + ";" +
                                    " Mileage:" + lista[ultimo].Mileage + ";" +
                                    " Ext_Voltage:" + lista[ultimo].Ext_Voltage + ";" +
                                    " Battery_Voltage:" + (lista[ultimo].Battery_Voltage) / 1000 + ";" +
                                    " Speed_:" + lista[ultimo].Speed_;
                        ...
                        for (int j = 0; j < cnt; j++)
                        {
                            ...
                            switch (id)
                            {
                                ...
                                case BATTERYVOLTAGE:
                                    {
                                        var value = Int16.Parse(Parsebytes(byteBuffer, index, 2), System.Globalization.NumberStyles.HexNumber);
                                        position.Battery_Voltage = value;
                                        index += 2;
                                        break;
                                    }
                                case SPEED_:
